...
const KEY_A = Buffer.from("0001020304050607080900010203040506070809000102030405060708090001", "hex");
const KEY_B = Buffer.from("1111111111111111111111111111111111111111111111111111111111111111", "hex");
const KEY_C = Buffer.from("f00dcafef00dcafef00dcafef00dcafef00dcafef00dcafef00dcafef00dcafe0", "hex");
...
describe("EdDSA js test", function () {
    ...
    const asMsg = (big) => ({ msg: eddsa.babyJub.F.e(big), msgRN: BigInt(Scalar.toString(big)) });
    const toF = (pair) => [eddsa.babyJub.F.e(pair[0]), eddsa.babyJub.F.e(pair[1])];
    ...
    it("RN signPoseidon is deterministic for identical (key, msg)", () => {
        ...
        assert(eddsa.babyJub.F.eq(eddsa.babyJub.F.e(s1.R8[0]), eddsa.babyJub.F.e(s2.R8[0])));
        assert(eddsa.babyJub.F.eq(eddsa.babyJub.F.e(s1.R8[1]), eddsa.babyJub.F.e(s2.R8[1])));
